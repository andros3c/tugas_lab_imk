...
<br><br><br>
      <div class="col-md-4 col-md-offset-4">
        ...
        <table id="daftar" width="100%" >
          ...
          ?>
          <tr>
            <td>&nbsp;</td><td><button class="btn btn-primary btn-lg btn-danger" type="submit" name="btnUbah">Simpan Perubahan</button></td>
          </tr>
        </table>
        </h3>
      </form><br>
	  <a href="admin.php"><button class="btn btn-primary btn-lg">Kembali</button></a>
